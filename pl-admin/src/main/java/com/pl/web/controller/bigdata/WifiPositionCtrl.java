...
public class WifiPositionCtrl extends BaseController {
     ...
     * 列表展示数据
     */
    @RequestMapping("bigdata/wifidata/positionList")
    @ResponseBody
    ...
    @RequestMapping("bigdata/wifidata/position")
    public String positionlist() {
        return "bigdata/wifidata/positionlist";
    }

    @RequestMapping("bigdata/wifidata/positionlistadd")
    public String positionlistadd() {
        return "bigdata/wifidata/positionlistadd";
    }

    @RequestMapping("bigdata/wifidata/positionlistedit/{id}")
    public String positionlistedit(ModelMap mm, @PathVariable("id") int id) {
        WifiPosition wifiPosition = this.wifiPostionServiceIMP.getWifiPostionId(id);
        mm.put("wifipost", wifiPosition);
        return "bigdata/wifidata/positionlistedit";
    }

    /*
     * 添加数据
     */
    @RequestMapping("bigdata/wifidata/addwifipot")
    @ResponseBody
    public AjaxResult AddWifiPot(ModelMap mm, WifiPosition wifiPosition, HttpServletRequest request) {
     ...
     * 删除数据
     */
    @RequestMapping("bigdata/wifidata/DeleteWifiPot/{id}")
    @ResponseBody
    public AjaxResult DeleteWifPot(@PathVariable("id") int id) {
     ...
     * 更新数据
     */
    @RequestMapping("bigdata/wifidata/updateWifiPot")
    @ResponseBody
    public AjaxResult UpdateWifiPot(WifiPosition wifiPosition) {
