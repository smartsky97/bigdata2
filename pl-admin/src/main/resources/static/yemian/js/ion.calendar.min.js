                ...
                if (!n.data("isActive")) {
                    ...
                    B = function() {
                        ...
                        if (c.sundayFirst) {
                            ...
                            for (b = 1; b <= y; b++) a = moment(d).date(b).format("D.M.YYYY") === t.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_current">' + b +'<div class="event"><div class="vnt"><a>[王聪]</a><span>新的日程安排1</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排2</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排3</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排4</span></div></div>' + "</td>") : g && moment(d).date(b).format("D.M.YYYY") === g.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_selected">' + b + '<div class="event"><div class="vnt"><a>[王聪]</a><span>新的日程安排1</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排2</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排3</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排4</span></div></div>'    + "</td>") : a + ('<td class="ic__day">' + b + '<div class="event"><div class="vnt"><a>[王聪]</a><span>新的日程安排1</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排2</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排3</span></div><div class="vnt"><a>[王聪]</a><span>新的日程安排4</span></div></div>'   + "</td>"),
            ...
            return this.each(function() {
                ...
                if (!a.data("isActive")) {
                    ...
                    var p = function() {
                        ...
                        c.css("left", v + g + 10 + "px").css("top", x - 10 + "px"); (h = a.prop("value")) && (h !== d && 0 > b.format.indexOf("L")) && (k = moment(h, b.format), k.isValid() && c.ionCalendar("update", {
                            startDate: h
                        }))
                    }; (function() {
